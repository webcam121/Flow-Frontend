...
import { getIotEvents } from "../../../api/iot"
...
const IotDashboard = () => {
    ...
    useEffect(() => {
        handleSearch({sensor: '', type: ''});
    }, [])

    const handleSearch = (query: any = null) => {
        dispatch(setLoading(true));
        getIotEvents(query ? query: filter)
            .then(resp => {
        ...
        <MainPageLayout>
            ...
            <div className="container mx-auto">
                <div className="bg-white rounded-lg px-30 py-10">
                    <p className="text-primary text-16 font-bold leading-[18px]">IoT Dashboard</p>
                </div>
                ...
                <div className="bg-white rounded-lg p-30 my-20">
                    <div className="md:flex items-center">
                        <div className="flex-grow grid grid-cols-1 md:grid-cols-2 gap-15">
                            ...
                            <div>
                                <input type="text" className="input" placeholder="Enter Sensor’s Type" onChange={(e) => handleFilterChange("type", e.target.value)} value={filter.type}/>
                            </div>
                        </div>
                    ...
                    <div className="mt-25 overflow-auto">
                        ...
                        >
                            ...
                            <Table.Column width={150} fixed verticalAlign="middle" sortable>
                            ...
                            <Table.Column width={110}  verticalAlign="middle" sortable>
                            ...
                            <Table.Column flexGrow={1}  verticalAlign="middle" sortable>
